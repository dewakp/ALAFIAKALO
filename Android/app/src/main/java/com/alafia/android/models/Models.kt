...
data class IntradialyticReading(
    ...
    @SerializedName("tmp_pressure") val tmpPressure: Float?,
    @SerializedName("uf_volume_removed") val ufVolumeRemoved: Float?,
    @SerializedName("uf_rate") val ufRate: Float?,
    @SerializedName("dialysate_temp") val dialysateTemp: Float?,
    @SerializedName("conductivity") val conductivity: Float?,
    @SerializedName("heparin_dose") val heparinDose: String?,
    @SerializedName("symptoms_noted") val symptomsNoted: String?,
    @SerializedName("interventions") val interventions: String?,
    @SerializedName("nurse_initials") val nurseInitials: String?,
    @SerializedName("created_at") val createdAt: String?
)
