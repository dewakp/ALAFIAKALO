...
_TOOL_LOOP_INSTRUCTIONS = (
    ...
    "\n\nYOU HAVE NOT SEEN THIS PATIENT'S LOGS. Nothing in this prompt "
    "contains their meals, medications, vitals or labs — only their profile "
    "and targets. So you cannot know whether an entry exists until a tool "
    "tells you. NEVER say a record is empty, missing or unavailable unless a "
    "tool you called returned it empty. Saying \"I don't have an entry for "
    "yesterday\" without calling get_meals is stating a fact you have no way "
    "of knowing, and it has told patients they logged nothing on days they "
    "logged six meals."
